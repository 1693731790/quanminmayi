...
class Menu extends \yii\widgets\Menu
{
    ...
    {
        if(isset($item['items'])) {
            $labelTemplate = '<a href="{url}">{icon} {label} <span class="caret pull-right"></span></a>';
            $linkTemplate = '<a href="{url}">{icon} {label} <span class="caret pull-right"></span></a>';
        }
        else {
    ...
    protected function renderItems($items)
    {
        ...
        foreach ($items as $i => $item) {
            $options = array_merge($this->itemOptions, ArrayHelper::getValue($item, 'options', ['class'=>'has-sub']));
