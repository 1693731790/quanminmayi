...
/* @var $searchModel common\models\GoodsFreeTakeSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = '免费拿商品';
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="goods-free-take-index">
...
<script>
  ...
  {
      $.get("<?=Url::to(['goods-free-take/goods-lowerframe'])?>",{"goods_id":goods_id,"sale":sale},function(r){
        if(r.success)
        {
            layer.msg(r.message);
            setTimeout(function(){
    ...
    function status(id)
    {
        var url="<?=Url::to(['goods-free-take/status'])?>";
        //alert(url);
        layer.open({
          type: 2,
          title: '审核商品',
