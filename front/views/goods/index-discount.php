...
<!-- <header>
         <a href="indexs.html"><div class="_lefte"><i class="iconfont icon-back is"></i></div></a>
</header> -->
...
<?php endif;?>
<div class="outer"><img class="picq" src="/webstatic/images/beiji_01.jpg"/></div>
<div class="outerone">爆款热销</div>
<div class="centers">
  <div class="centerone"><img class="centertwos" src="<?=$goods[0]["goods_thums"]?>"/></div>
  <div class="centertwo">
    <div class="centertwoone"><?=$goods[0]["title"]?></div>
  ...
  <ul id="list_box">
    ...
    <li>
      ...
      <div class="pilone">
        ...
        <div class="pilonetwo">￥<?=$goodsVal['price']?></div><div class="pilonethree">立即购买</div>
      </div>
    </a>
    </li>
  <?php endif;?>
