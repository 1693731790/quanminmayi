...
<div id="list_box">
 <?php if(empty($goods)):?>
  <div style="margin-top:30%;margin-left:23%;font-size:2rem">正在上传</div>
  <?php else:?>
...
//加载数据
 function LoadingDataFn() {
    $.get("<?=Url::to(['goods/goods-list'])?>",{"page":page,"goods_cate_id":"<?=$goods_cate_id?>","goods_brand":"<?=$goods_brand?>","shop_id":"<?=$shop_id?>","shops_cate":"<?=$shops_cate?>","shops_class":"<?=$shops_class?>","shops_limit":"<?=$shops_limit?>","price2":"<?=$price2?>","price4":"<?=$price4?>"},function(da){
