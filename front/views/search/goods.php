...
<link rel="stylesheet" type="text/css" href="/webstatic/css/fontsizes/iconfont.css" />
 ...
 <header class="module-layer">
    <div class="module-layer-content">
          ...
          <div class="headerthree" style="text-align:left;"><input id="searchKey" type="text" placeholder="搜索您想要的商品" name="key" value=""  style="margin-left:0.6rem;width:9.4rem;height:1rem;line-height:1rem;margin-top:0.3rem; background: transparent;" /><img class="shop-search" src="/webstatic/images/icon_search.png" id="searchSub" style="margin-top:-1.16rem"/></div>
...
//加载数据
 function LoadingDataFn() {
    $.get("<?=Url::to(['search/goods-list'])?>",{"page":page,"salecount":"<?=$salecount?>","browse":"<?=$browse?>","new":"<?=$new?>","searchKey":"<?=$searchKey?>","istodaynew":"<?=$istodaynew?>","isselected":"<?=$isselected?>","shop_id":"<?=$shop_id?>"},function(da){
             $('#list_box').append(da);                                      
    })
