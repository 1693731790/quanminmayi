...
<div class="chongzhione">
  <div class="rightt">
    <input id="shop-input" type="text" placeholder="" value="<?=$phone?>" style="border:none;"/>
  </div>
</div>
<div class="chongzhitwo">
  <div class="left">充值卡卡号:</div>
  <div class="right">
    <input id="shop-input" type="text" placeholder="请输入卡号" name="cardName" style="border:none;"/>
  </div>
</div>
<div class="chongzhithree">
  <div class="left">充值卡密码:</div>
  <div class="right">
    <input id="shop-input" type="text" placeholder="请输入密码" name="cardPwd"  style="border:none; "/>
  </div>
</div>
...
<script type="text/javascript">
  $(function(){
      $(".submit").click(function(){
          ...
          if(check)
          {
              $.post("<?=Url::to(['user/recharge'])?>",{"cardName":cardName,"cardPwd":cardPwd},function(r){
                  if(r.success)
                  {              
                      layer.msg(r.message);        
                      setTimeout(function(){
