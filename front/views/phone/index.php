...
<style>
 ...
 .tanchubox{min-height: 24rem;-webkit-overflow-scrolling:touch;overflow-y:scroll;  position: absolute; top:0; bottom:0;left:0; right: 0; background: #fff}
  #shop-input{width:96%;padding-left:2%;padding-right: 2%; text-align: center;margin:0;height:2rem; line-height: 2rem}
  .onet ul li{ cursor: auto}
  .onet ul li:active{-webkit-tap-highlight-color:transparent; background: #fc3b3e;}
  .onet ul li:active .call,.onet ul li:active .calls{color:#fff;}
  .firstlilte{position: absolute; bottom:22rem;}
  .twotlilte{margin-top:0.5rem; height: 17.4rem; overflow:hidden;position: absolute; bottom:4.6rem;}
  .threelilte{ position: absolute; bottom:1rem; }
  .threelilte ul{margin-left:10%;}
  .threelilte ul li{ cursor: auto;padding:0rem;width:30%; }
  .piqtwo{ margin-left:-0.7rem; }
  .piqthree{ margin-left:0.6rem; background: url(/webstatic/images/ipo1_03.jpg) left top no-repeat; background-size: 100% 100%;-webkit-tap-highlight-color: rgba(0, 0, 0, 0);-webkit-tap-highlight-color: transparent;}
...
<div class="change-content change-box">
        ...
        <!-- <div class="fdf"> -->
            <div class="change-cut flex-row">
               <ul class="clearfix" style="margin-left: 4.8rem;">
            ...
            <div class="contents clearfix" style="margin-bottom: 6rem">
                <div class="content flex-row" style="display: block;">
                 <div class="waice"> 
                  <?php if(!empty($callLog)):?>
                <?php foreach($callLog as $val):?>
                <div class="firsto">
                  <div class="ipleft">
                      <div class="iplefta"><span class="iconfont">&#xe612;</span></div>
                      <div class="ipleftb"><?=$val["name"]!=""?$val["name"]:"未知"?></div>
                      <div class="ipleftc"><?=$val["callNum"]?></div>
                      
                  </div>
                  <div class="ipright">
                      <div class="timeright"><?=date("n/j H:i",$val["time"])?></div>
               ...
               <?php endif;?>
                ...
                <div class="fixeds">
                    <img class="tpp" src="images/tubiao1_03.jpg"/><div class="headers">
                        新建联系人
                    </div>
                </div> -->

<div id="letter"></div>
<!--<div class="sort_box" id="callList">
   <div class='sort_list' onclick='call("178 1074 7119","666")'><div class='num_name'>666</div><div class='callnum'>178 1074 7119</div></div>
...
<div class="initials">
    <ul>
     ...
     <div class="tanchubox" style="display:none;">
       <div class="firstlilte"><input id="shop-input"  class="phoneNum"  type="text" placeholder="" value="" /></div> 
       <div class="twotlilte">
       <div class="onet"><ul>
       ...
       <div class="threelilte">
        ...
        <li><img class="piqtwo"  onclick="call()" src="/webstatic/images/iphone3_03.jpg"/></li>
        <li><div class="piqthree"></div></li>
        </ul>
       </div>
   </div>
...
{ 
     ...
     $.get("<?=Url::to(['phone/call-back'])?>",{"caller":phoneNum},function(r){
		
       
        if(r.success)
        { 
         
          window.location.href="/phone/call-view.html?mobileNum="+phoneNum;
        }else{
          layer.msg("呼叫失败");
          return false;
        }
...
function getCallLog() {
    var content="";
    var nocall="<div class='sort_list'><div class='nocall'>暂无联系人</div></div>";
    var error="";
    try{
            ...
            addressbook.find(["displayName","phoneNumbers"],function(contacts){
                ...
                for(var i=0;i<contacts.length;i++){
                    for(var j=0;j<contacts[i].phoneNumbers.length;j++){
                        content+="<div class='sort_list' onclick='call(\""+contacts[i].phoneNumbers[j].value+"\",\""+contacts[i].displayName+"\")'><div class='num_name'>"+contacts[i].displayName+"</div><div class='callnum'>"+contacts[i].phoneNumbers[j].value+"</div></div>";
                    }
                }
                
                if(contacts.length>0)
                {
                    $("#callList").append(content);
                }else{
                    $("#callList").append(nocall);
                }    
