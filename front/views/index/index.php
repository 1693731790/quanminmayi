...
<style>
 ...
 a:hover {
  ...
  .slideBox .bd li img{height:5.803rem}
  .slideBox .bd{height:5.803rem}
  .topt{height:6.6rem;}
  .toppa{width: 5.547rem; height: 5.547rem;margin-left:0rem}
  .toppb{width: 9rem;height: 2.56rem;margin-right: 0.512rem;margin-left: 0rem;}
  .toppc{width: 9rem;height: 2.56rem;margin-right: 0.512rem;margin-top: 0.42rem;}
  .daojishi{margin-top:1.7rem}
   #timer{margin-top:1.6rem}
</style>
...
<header class="module-layer">
    <div class="module-layer-content">
      ...
      <?php if(strpos($_SERVER['HTTP_USER_AGENT'],'MicroMessenger')!==false):?>
           ...
           <p class="layer-login" > <a href="javascript:;" onclick="scanQRCode()"><img class="che" src="/webstatic/images/scan.png"></a> </p>
      <?php else:?>
  ...
  wx.ready(function () {
    ...
    function scanQRCode() {
      ...
      success: function (res) {
        ...
        var url="<?=Url::to(["af-code/af-code-show"])?>"+"?number="+result+"&type=1"+"&nickname=<?php // $result->nickname?>&province=<?php // $result->province?>";
        //alert(url);
...
<div class="out">
    ...
    <div class="topt">
        <a style="display:block;float:left;width:5.547rem;height:5.547rem;margin-left:0.512rem;" href="<?=Url::to(["goods/index","isjd"=>"1"])?>"><div class="toppa"></div></a>
