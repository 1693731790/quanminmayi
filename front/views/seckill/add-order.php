...
<form id="orderform" action="<?=Url::to(['seckill/confirm-add-order'])?>" method="post">
<div class="Web_Box">
          ...
          <li>
            ...
            <div class="Con">
              ...
              <div class="pl20">
                ...
                <p class="PriceQuantity"><span class="fl cr_f84e37">￥<?=$goods->seckill_price?></span><span class="fr cr_282828">×<?=$num?></span></p>
              </div>
            </div>
          </li>
    ...
    <div class="OtherInfo bg_fff mt20">
      <ul>
        ...
        <li class="Total">合计：<span class="cr_fd6847">￥<span id="countFee">
          <?php echo round($goods->seckill_price*$num,2);?>
