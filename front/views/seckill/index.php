...
<header style="<?=$token!=""?"display:none":""?>">
            ...
            <div id="tab_bar">  
                <ul id="time_ul"> 
                  <?php foreach($spikeTime as $spikeTimeKey=>$spikeTimeVal):?> 
                    ...
                    <?php else:?>
                      <li style="<?=$spikeTimeVal->id==$time_id?"color:#fff;border-bottom: solid #fff 2px;":"color:#fff;opacity:0.5;"?>"  id="<?=$spikeTimeKey?>">
                    <?php endif;?>  
            ...
            <script type="text/javascript">
             $(function(){
              ...
              function golink(id,k)
              {
                  ...
                  window.location.href="<?=Url::to(["seckill/index"])?>"+"?time_id="+id+"&token=<?=$token?>"+"&#"+k;
              }
            </script>
            ...
            <div class="tab_css" id="tab1_content" style="display:block">  
                ...
                <div class="pageone">
                  ...
                  <div class="rightwenzi">
                      ...
                      <div class="rightwenzithree">¥<?=$goodsVal->seckill_price?>&nbsp<span class="price">¥<?=$goodsVal->old_price?></span></div>
                      <div class="rightwenzifour"><div class="righttitle">已抢<?=$goodsVal->seckill_stock-$goodsVal->seckill_surplus?>件</div>
                          <div class="progress">
                              <div class="bar" style="width:<?=round(($goodsVal->seckill_stock-$goodsVal->seckill_surplus)/$goodsVal->seckill_stock*100,0)?>%;"></div>
                          </div>
