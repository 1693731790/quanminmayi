...
<div class="Web_Box">
  <div class="CommissionPresent">
    <div class="HeadBox" style="background:#fc3b3e">
      <div class="head">
        <div class="leftcon"><i class="iconfont icon-leftdot" onclick="javascript:history.go(-1)" style="<?=$_GET["token"]!=""?"display:none":""?>"></i> <span>账户余额(元)</span> </div>
       ...
       <li class="lh70 f24 cr_898989">注：金额需大于100元才可提现。</li>
        <li class="CashWithdrawal">
          ...
          <div class="fl GetVerificationCode">
            <button type="button" id="allfee" style="color:#fc3b3e">全额提出</button>
          </div>
        </li>
        <li class="CashWithdrawal">
  ...
  <div class="pl20 pr20 mt60">
    <button type="button" class="but_1 wauto" id="submit" style="background:#fc3b3e">申请提现</button>
  </div>
</div>
