    ...
    <div class="panel panel-info">
      ...
      <div class="panel-body">
        ...
        <tr>
            <th>商品标题图片</th>
            <td colspan="3">
                <img src="<?=Yii::$app->params['imgurl'].$model->goods_thums?>" style="width:150;height: 100px;">
            </td>
        ...
        <tr>
            <th>销量</th><td><?=$model->salecount?></td>
        ...
        <tr>
          ...
          <tr>
            <th>店铺分类</th><td><?=ShopsClass::getCateName($model->shops_class1)?>-<?=ShopsClass::getCateName($model->shops_class2)?></td>
            <th>店铺品牌</th><td><?=ShopsCate::getCateName($model->shops_cate)?></td>
        </tr>
        <tr>
            <th>供货商</th>
        ...
        <div class="jq_uploads_img" >
           <?php if($model->goods_img):?>
              <?php for($i=0;$i<count($model->goods_img);$i++):?>
                <span style="width: 150px; height: 100px;float: left; margin-left: 5px; margin-top: 10px;">  <img width="80" height="80" src="<?=Yii::$app->params['imgurl'].$model->goods_img[$i]?>">  </span>
               <?php endfor;?>                
            <?php endif;?>
        </div>
