...
class ConfigSearch extends Config
{
    ...
    public function rules()
    {
        return [
            [['id'], 'integer'],
            [['web_name', 'web_link', 'web_key', 'web_describe', 'web_call', 'web_copyright'], 'safe'],
        ];
    }
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere(['like', 'web_name', $this->web_name])
            ...
            ->andFilterWhere(['like', 'web_describe', $this->web_describe])
            ->andFilterWhere(['like', 'web_call', $this->web_call])
            ->andFilterWhere(['like', 'web_copyright', $this->web_copyright]);
