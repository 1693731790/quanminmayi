...
class SearchController extends CommonController
{
      ...
      public function actionGoods($searchKey="",$salecount="",$browse="",$new="",$istodaynew="",$isselected="")
      {
          ...
          //$this->dump($orderby);
          $goods=$model->asArray()->where(["status"=>"200","issale"=>"1"])->andFilterWhere(['istodaynew'=>$istodaynew])->andFilterWhere(['isselected'=>$isselected])->andFilterWhere(['like', 'goods_name', $searchKey])->orderBy($orderby)->limit(10)->all();
      ...
      function actionGoodsList($page="",$searchKey="",$salecount="",$browse="",$new="",$istodaynew="",$isselected="")
      {
          ...
          $goods=$model->asArray()->where(["status"=>"200","issale"=>"1"])->andFilterWhere(['istodaynew'=>$istodaynew])->andFilterWhere(['isselected'=>$isselected])->andFilterWhere(['like', 'goods_name', $searchKey])->orderBy($orderby)->offset($page)->limit(10)->all();
