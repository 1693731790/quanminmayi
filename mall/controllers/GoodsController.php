...
class GoodsController extends Controller  //CommonController
{
  ...
  function beforeAction($action)
  {
      ...
      public function actionIndex($goods_cate_id="",$salecount="",$browse="",$new="",$goods_brand="",$isjd="",$isdigital="",$isdiscount="",$istodaynew="",$isselected="")
      {
          ...
          $goods=$model->asArray()->where(["status"=>"200","issale"=>"1"])->andFilterWhere(["goods_brand"=>$goods_brand,"cate_id3"=>$goods_cate_id,"shop_id"=>$isjd,"isdigital"=>$isdigital,"isdiscount"=>$isdiscount,'istodaynew'=>$istodaynew,'isselected'=>$isselected])->orderBy($orderby)->limit(30)->all();
      ...
      function actionGoodsList($page="",$goods_cate_id="",$salecount="",$browse="",$new="",$goods_brand="",$isjd="",$isdigital="",$isdiscount="",$istodaynew="",$isselected="")
      {
          $page=($page-1)*30;
          $model=Goods::find();
          $orderby='browse DESC';
          ...
          $goods=$model->asArray()->where(["status"=>"200","issale"=>"1"])->andFilterWhere(["goods_brand"=>$goods_brand,"cate_id3"=>$goods_cate_id,"shop_id"=>$isjd,"isdigital"=>$isdigital,"isdiscount"=>$isdiscount,'istodaynew'=>$istodaynew,'isselected'=>$isselected])->orderBy($orderby)->offset($page)->limit(30)->all();
