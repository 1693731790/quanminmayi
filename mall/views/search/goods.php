...
//加载数据
 function LoadingDataFn() {
    $.get("<?=Url::to(['search/goods-list'])?>",{"page":page,"salecount":"<?=$salecount?>","browse":"<?=$browse?>","new":"<?=$new?>","searchKey":"<?=$searchKey?>","istodaynew":"<?=$istodaynew?>","isselected":"<?=$isselected?>"},function(da){
             $('#list_box').append(da);                                      
    })
