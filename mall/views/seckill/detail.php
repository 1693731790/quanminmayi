...
<div class="outer">
 <div class="index-banner">
  ...
  <div class="outertwo">
    ...
    <div class="outertwotwo">¥<?=$model->seckill_price?>&nbsp<span class="haha">¥<?=$model->old_price?></span></div>
...
<div class="PurchaseOperation gd">
  ...
  <div class="right fr" style="width: 100%;">
    ...
    <?php if($seckill_start_time>time()):?>
        <button type="button"  class="but bg_ff5c36" style="width: 100%; color:#fff;background: #ccc" >秒杀未开始</button>

    <?php elseif($seckill_end_time<time()):?>
        <button type="button"  class="but bg_ff5c36" style="width: 100%;color:#fff;background: #ccc">秒杀已结束</button>
    <?php else:?>
        <button type="button"  class="but bg_ff5c36" style="width: 100%;" onClick="OpenPop('#PopBg,#AttributeSelectionPop')">立即购买</button>      
    <?php endif;?>
...
<div class="AttributeSelectionPop disn" id="AttributeSelectionPop">
  ...
  <i class="iconfont icon-close" onClick="ClosePop('#PopBg,#AttributeSelectionPop')"></i>
    ...
    <p class="Price fl skuprice">￥<?=$model->seckill_price?></p>
...
<form id="orderform" action="<?=Url::to(['seckill/add-order'])?>" method="post">
  ...
  <input type="hidden" name="is_seckill" value="1">
