...
<div class="outertwo">订单支付中</div>
<div class="outerfour"><div class="outerfourone"><a href="<?=Url::to(["user/order"])?>" style="color:#fff">查看订单</a></div><div class="outerfourtwo"><a href="<?=Url::to(["index/index"])?>" style="color:#fc3b3e">返回首页</a></div></div>
</div>
