...
<div class="chongzhitwo">
  ...
  <div class="right">
    <input id="shop-input" type="text" placeholder="请输入卡号" name="cardName" value="<?=$card_num?>" readonly="readonly" style="border:none;"/>
  </div>
</div>
<div class="chongzhithree">
  <div class="left">充值卡密码:</div>
  <div class="right">
    <input id="shop-input" type="text" placeholder="请输入密码" name="cardPwd" value="<?=$password?>" readonly="readonly"  style="border:none; "/>
  </div>
</div>
