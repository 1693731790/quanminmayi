              ...
              <div class="panel-body">
                <table class="table table-bordered" style="float:left;">
                  ...
                  <tr>
                      ...
                      <th><a class="btn btn-success" href="<?=Url::to(['agent/go-pay','all_pay_sn'=>$val->orderAllPay->all_pay_sn])?>">去支付</a> <a class="btn btn-danger" href="<?=Url::to(['agent/agent-delete','agent_id'=>$val->agent_id])?>">删除</a></th>
