    ...
    <div id="page-container" class="page-container fade page-sidebar-fixed page-header-fixed">
        <?php 
            $callback = function($menu){
                ...
                $navs=$top_navs;
                if($this->context->module->id=='weixin'){
                    foreach($top_navs as $v){
                        if($v['label']=='微信商城'){
                            $navs=$v['items'];
                            break;
                        }
                    }
                }elseif($this->context->module->id=='rbac'){
                    foreach($top_navs as $v){
                        if($v['label']=='权限管理'){
                            $navs=$v['items'];
                            break;
                ...
                }elseif($this->context->module->id=='guanwang'){
                    foreach($top_navs as $v){
                        if($v['label']=='官网'){
                            $navs=$v['items'];
                            break;
