...
class AlipayTradeService {
	...
	function appPay($builder,$return_url,$notify_url) {
	   ...
	   echo  $biz_content=$builder->getBizContent();
	    //打印业务参数
	    $this->writeLog($biz_content);
...
echo 	    $aop->rsaSign($biz_content);
	 ...
	 function aopclientRequestExecute($request,$ispage=false) {
		...
		{
			echo $result = $aop->Execute($request);
		}
	...
	function writeLog($text) {
		...
		//$text = characet ( $text );
		file_put_contents ( dirname ( __FILE__ ).DIRECTORY_SEPARATOR."./../../../../runtime/log.txt", date ( "Y-m-d H:i:s" ) . "  " . $text . "\r\n", FILE_APPEND );
	}
