...
<div class="Head88 pt88">
  <header class="TopGd"> <i class="iconfont icon-leftdot"></i>
    <h2>注册新用户</h2>
  </header>
...
<script type="text/javascript">
    ...
    $("#useradd").click(function(){
        ...
        if(check==true)
        {
            $.get("<?=Url::to(['site/signup-by-phone'])?>",{"username":username,"phone":phone,"password":password,"verifycode":verifycode},function(data){
